...
const LandingPage = () => {
  const features = [
    ...
    {
      title: 'Task Tracking',
      description: 'Assign tasks, set deadlines, and monitor progress in real-time.',
      icon: '✓',
    },
    {
      title: 'Document Management',
      description: 'Store and share blueprints, contracts, and other important documents.',
      icon: '📄',
    },
    {
      title: 'Team Collaboration',
      description: 'Keep your entire team connected and informed throughout the project.',
      icon: '👥',
    },
  ];
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block xl:inline">Construction management</span>{' '}
      ...
      <section className="bg-primary-700">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg leading-6 text-primary-200">
            Join thousands of construction professionals who trust BlueHooper to manage their projects.
          </p>
          <Link
            to="/register"
